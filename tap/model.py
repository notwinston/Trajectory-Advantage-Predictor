...
* ONE 4-head cross-attention from the candidate to its <=8 history records
...
from tap.dataset import CANDIDATE_NUMERIC_COLS, HISTORY_WINDOW, STATE_NUMERIC_COLS
...
DEFAULT_DIMS = dict(
    ...
    state_dim=len(STATE_NUMERIC_COLS) + POLICY_FINGERPRINT_DIM,
